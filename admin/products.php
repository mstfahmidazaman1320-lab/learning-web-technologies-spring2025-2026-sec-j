        ...
        <form method="POST" action="index.php?page=admin-products" enctype="multipart/form-data" onsubmit="return validateProductForm()" novalidate>
            ...
            <div class="form-grid">
                ...
                <div>
                    ...
                    <input type="file" name="image" id="product_image" accept="image/jpeg,image/png">
            ...
            <?php if ($isEdit && !empty($editProduct['image_path'])): ?>
                ...
                <img class="thumb" src="<?= e($editProduct['image_path']) ?>" alt="Current Product Image">
            <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($product['image_path'])): ?>
                                    <img class="table-img" src="<?= e($product['image_path']) ?>" alt="<?= e($product['name']) ?>">
                                <?php else: ?>
